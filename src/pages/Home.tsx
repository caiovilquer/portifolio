  ...
  >
    ...
    <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center pt-20">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-[var(--text-tertiary)] max-w-2xl mx-auto mb-10 leading-relaxed">
    ...
    {/* Scroll Indicator */}
    <motion.div
      className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-[var(--text-tertiary)]"
      initial={{ opacity: 0 }}
